#!/bin/bash
#SBATCH --job-name=fullcolfib
#SBATCH --output=/home/aenovt/out_err/fullcolfib/out.out
#SBATCH --error=/home/aenovt/out_err/fullcolfib/err.err
...
cd /home/aenovt/scratch/fullcol-files

# Get the threads from the variable cpus per task - should be same number
export OMP_NUM_THREADS="${SLURM_CPUS_PER_TASK:-1}"

# --- THIS SECTION ADD IT THROUGH INPUT (PROMPTED, CHOOSE PHASES TO RUN) ---

# Energy Minimization Phase
srun gmx grompp -f minimize.mdp -c ticf-solvtd-ions.gro -p topol.top -o em.tpr
...
# Production Phase (MD Run) - maxwarn due to angular/translation restrain
